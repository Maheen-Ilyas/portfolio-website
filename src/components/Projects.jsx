...
const CardFlip = ({ project }) => {
  return (
    <motion.div
      ...
      className="flip-card w-[300px] h-[300px] mb-10 rounded-[10px] perspective mx-4"
    >
      <div
      ...
      >
        ...
        >
          ...
          <p className="text-[14px] font-poppins mb-6">{project.description}</p>
          ...
          <a href={project.source_code_link} target="_blank">
            <img src={github} className="mt-4 w-[40px] h-[40px]" />
          </a>
        </div>
      </div>
    </motion.div>
